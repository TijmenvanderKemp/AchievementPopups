...
import achievementpopups.cards.cardvars.SecondDamage;
import achievementpopups.cards.cardvars.SillyVariable;
import achievementpopups.relics.AbstractEasyRelic;

import java.nio.charset.StandardCharsets;

@SuppressWarnings({"unused", "WeakerAccess"})
@SpireInitializer
public class AchievementPopupsMod implements
        EditCardsSubscriber,
...
PostRenderSubscriber{
    ...
    private static String modID = "achievementpopups";
    ...
    public static void initialize() {
        AchievementPopupsMod achievementPopupsMod = new AchievementPopupsMod();
    }
    ...
    public void receivePostRender(SpriteBatch spriteBatch) {
        AchievementTracker.renderAllQueuedAchievements(spriteBatch);
    }
}
